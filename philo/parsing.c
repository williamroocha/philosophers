...
/*   Updated: 2024/05/08 09:58:35 by wiferrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parse_args(t_table *table, char **av)
{
	...
	if (table->time_to_die < 6e4 || table->time_to_eat < 6e4
		...
		error_exit("The minimum value is 60ms");
	if (av[5])
	{
		table->meals_nbr_max = ft_atol(av[5]);
		if (table->meals_nbr_max < 1)
			error_exit("The number of meals must be at least 1");
	}
	else
